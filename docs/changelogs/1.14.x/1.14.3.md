...
* Support end-of-battle party data check in tests by @AsparagusEduardo in [#8831](https://github.com/rh-hideout/pokeemerald-expansion/pull/8831)
    - If you added tests that checks for party data (`gParties[B_TRAINER_0]`), make sure that you're not using a species which changes form at the end of the battle, as its data could be overriten by the form change.
