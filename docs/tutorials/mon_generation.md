...
It means they are usually called with `&gParties[B_TRAINER_PLAYER][index]` or `&gParties[B_TRAINER_OPPONENT_A][index]` because these are places in memory reserved for Pokemon struct.
