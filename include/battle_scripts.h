...
extern const u8 BattleScript_InversionPolicyEnds[];
extern const u8 BattleScript_DistractionPolicyEnds[];
extern const u8 BattleScript_SpotlightPolicyEnds[];
...
extern const u8 BattleScriptInversionPolicyRet[];
extern const u8 BattleScriptDistractionPolicyRet[];
extern const u8 BattleScriptSpotlightPolicyRet[];
...
extern const u8 BattleScript_EffectEnlightening[];
