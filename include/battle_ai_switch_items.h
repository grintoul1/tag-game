...
enum ShouldPartnerSwitchScenario
{
    PARTNER_SHOULD_SWITCH_WONDER_GUARD,
    PARTNER_SHOULD_SWITCH_ABSORBS_MOVE,
    PARTNER_SHOULD_SWITCH_TRAPPER,
    PARTNER_SHOULD_SWITCH_FREE_TURN,
    PARTNER_SHOULD_SWITCH_TRUANT,
    PARTNER_SHOULD_SWITCH_ALL_MOVES_BAD,
    PARTNER_SHOULD_SWITCH_PERISH_SONG,
    PARTNER_SHOULD_SWITCH_YAWN,
    PARTNER_SHOULD_SWITCH_BADLY_POISONED,
    PARTNER_SHOULD_SWITCH_BADLY_POISONED_STATS_RAISED,
    PARTNER_SHOULD_SWITCH_CURSED,
    PARTNER_SHOULD_SWITCH_CURSED_STATS_RAISED,
    PARTNER_SHOULD_SWITCH_NIGHTMARE,
    PARTNER_SHOULD_SWITCH_NIGHTMARE_STATS_RAISED,
    PARTNER_SHOULD_SWITCH_SEEDED,
    PARTNER_SHOULD_SWITCH_SEEDED_STATS_RAISED,
    PARTNER_SHOULD_SWITCH_INFATUATION,
    PARTNER_SHOULD_SWITCH_HASBADODDS,
    PARTNER_SHOULD_SWITCH_NATURAL_CURE_STRONG,
    PARTNER_SHOULD_SWITCH_NATURAL_CURE_STRONG_STATS_RAISED,
    PARTNER_SHOULD_SWITCH_NATURAL_CURE_WEAK,
    PARTNER_SHOULD_SWITCH_NATURAL_CURE_WEAK_STATS_RAISED,
    PARTNER_SHOULD_SWITCH_REGENERATOR,
    PARTNER_SHOULD_SWITCH_REGENERATOR_STATS_RAISED,
    PARTNER_SHOULD_SWITCH_ENCORE_STATUS,
    PARTNER_SHOULD_SWITCH_ENCORE_DAMAGE,
    PARTNER_SHOULD_SWITCH_CHOICE_LOCKED,
    PARTNER_SHOULD_SWITCH_ATTACKING_STAT_MINUS_TWO,
    PARTNER_SHOULD_SWITCH_ATTACKING_STAT_MINUS_THREE_PLUS,
    PARTNER_SHOULD_SWITCH_ALL_SCORES_BAD,
};
