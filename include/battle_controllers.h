...
void SwapBattlerAiFlags(enum BattlerId battler1, enum BattlerId battler2);
...
static void (*const sBattleControllerFuncs[BATTLE_CONTROLLERS_COUNT])(enum BattlerId battler) =
{
...
static inline BattleControllerFunc GetBattlerBattleControllerSetFunc(enum BattlerId battler)
{
...
static inline void SwapBattlerBattleControllers(enum BattlerId battler1, enum BattlerId battler2)
{
