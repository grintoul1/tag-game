...
#define BATTLE_TEST_ARGS_MULTI(_name, _type, ...) \
    ...
    { \
        ...
        { \
            .type = _type, \
            .function = { .doubles = (MultiBattleTestFunction)CAT(Test, __LINE__) }, \
            .resultsSize = sizeof(struct CAT(Result, __LINE__)), \
        }, \
    }; \
    static void CAT(Test, __LINE__)(struct CAT(Result, __LINE__) *results, const u32 i, struct BattlePokemon *playerLeft, struct BattlePokemon *opponentLeft, struct BattlePokemon *playerRight, struct BattlePokemon *opponentRight)
...
#define BATTLE_TEST_ARGS_TWO_VS_ONE(_name, _type, ...) \
    ...
    { \
        ...
        { \
            .type = _type, \
            .function = { .doubles = (TwoVsOneBattleTestFunction)CAT(Test, __LINE__) }, \
            .resultsSize = sizeof(struct CAT(Result, __LINE__)), \
        }, \
    }; \
    static void CAT(Test, __LINE__)(struct CAT(Result, __LINE__) *results, const u32 i, struct BattlePokemon *playerLeft, struct BattlePokemon *opponentLeft, struct BattlePokemon *playerRight, struct BattlePokemon *opponentRight)
...
#define MULTI_OPPONENT_A_PARTY (gBattleTestRunnerStateMulti->data.recordedBattleMulti.opponentParty)
#define MULTI_PARTNER_PARTY (gBattleTestRunnerStateMulti->data.recordedBattleMulti.partnerParty)
#define MULTI_OPPONENT_B_PARTY (gBattleTestRunnerStateMulti->data.recordedBattleMulti.opponentBParty)
