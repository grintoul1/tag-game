...
//Time
#define OW_TIMES_OF_DAY                 FALSE   // Different generations have the times of day change at different times.
...
#define OW_FLAG_NO_COLLISION        TRUE  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
