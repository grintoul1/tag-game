...
#define B_PARALYSIS_SPEED           GEN_6      // In Gen7+, paralysis decreases Speed by 50% instead of 75%.
...
#define B_ABILITY_WEATHER               GEN_5      // In Gen6+, Ability-induced weather lasts 5 turns. In Gen5 and earlier, it lasted until the battle ended or until it was changed by another weather condition.
...
#define B_OBEDIENCE_MECHANICS           FALSE      // In PLA onwards (GEN_8 here), obedience restrictions also apply to non-outsider Pokémon, albeit based on their met level rather than their current level.
