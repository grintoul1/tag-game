...
enum RandomTag
{
    ...
    RNG_AI_CUSTOM_AI_NINETY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_NINETY_PERCENT,
    RNG_AI_CUSTOM_AI_EIGHTY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_EIGHTY_PERCENT,
    RNG_AI_CUSTOM_AI_SEVENTY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_SEVENTY_PERCENT,
    RNG_AI_CUSTOM_AI_SIXTY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_SIXTY_PERCENT,
    RNG_AI_CUSTOM_AI_FIFTY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_FIFTY_PERCENT,
    RNG_AI_CUSTOM_AI_FORTY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_FORTY_PERCENT,
    RNG_AI_CUSTOM_AI_THIRTY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_THIRTY_PERCENT,
    RNG_AI_CUSTOM_AI_TWENTY_FIVE_PERCENT,
    RNG_AI_CUSTOM_AI_TWENTY_PERCENT,
    RNG_AI_CUSTOM_AI_FIFTEEN_PERCENT,
    RNG_AI_CUSTOM_AI_TEN_PERCENT,
    RNG_AI_CUSTOM_AI_FIVE_PERCENT,
    RNG_TAG_AI_BEST_DAMAGE_MOVE,
    RNG_TAG_AI_HAZARDS,
