...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_MAGMA_ADMIN_F,
    TRAINER_PIC_FRONT_GREEN,
    TRAINER_PIC_FRONT_VITO,
    ...
    TRAINER_PIC_BACK_MAGMA_LEADER_MAXIE,
    TRAINER_PIC_BACK_AQUA_LEADER_ARCHIE,
    TRAINER_PIC_BACK_AQUA_ADMIN_M,
    TRAINER_PIC_BACK_AQUA_ADMIN_F,
    TRAINER_PIC_BACK_MAGMA_ADMIN,
    TRAINER_PIC_BACK_MAGMA_ADMIN_F,
    TRAINER_PIC_BACK_GREEN,
    TRAINER_PIC_COUNT,
...
#define FACILITY_CLASS_PKMN_TRAINER_1        0X52
#define FACILITY_CLASS_PKMN_TRAINER_2        0X53
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_TEAM_AQUA_MIXED,
    TRAINER_CLASS_TEAM_MAGMA_MIXED,
    TRAINER_CLASS_AQUA_ADMIN_MIXED,
    TRAINER_CLASS_MAGMA_ADMIN_MIXED,
    TRAINER_CLASS_FORMER_CHAMPION,
    TRAINER_CLASS_KANTONIAN,
...
#define TRAINER_ENCOUNTER_MUSIC_PKMN_TRAINER_2 14 // Emmie
