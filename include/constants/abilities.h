...
{
    ABILITY_NONE = 0,
    ABILITY_STENCH = 1, // used
    ABILITY_DRIZZLE = 2, // used
    ABILITY_SPEED_BOOST = 3, // used
    ABILITY_BATTLE_ARMOR = 4, // used
    ABILITY_STURDY = 5, // used
    ABILITY_DAMP = 6, // used
    ABILITY_LIMBER = 7, // NOT USED
    ABILITY_SAND_VEIL = 8, // used
    ABILITY_STATIC = 9, // used
    ABILITY_VOLT_ABSORB = 10, // used
    ABILITY_WATER_ABSORB = 11, // used
    ABILITY_OBLIVIOUS = 12, // NOT USED
    ABILITY_CLOUD_NINE = 13, // NOT USED
    ABILITY_COMPOUND_EYES = 14, // used
    ABILITY_INSOMNIA = 15, // NOT USED
    ABILITY_COLOR_CHANGE = 16, // NOT USED
    ABILITY_IMMUNITY = 17, // used
    ABILITY_FLASH_FIRE = 18, // used
    ABILITY_SHIELD_DUST = 19, // used
    ABILITY_OWN_TEMPO = 20, // used
    ABILITY_SUCTION_CUPS = 21, // NOT USED
    ABILITY_INTIMIDATE = 22, // used
    ABILITY_SHADOW_TAG = 23, // used
    ABILITY_ROUGH_SKIN = 24, // NOT USED
    ABILITY_WONDER_GUARD = 25, // used
    ABILITY_LEVITATE = 26, // used
    ABILITY_EFFECT_SPORE = 27, // used
    ABILITY_SYNCHRONIZE = 28, // used
    ABILITY_CLEAR_BODY = 29, // used
    ABILITY_NATURAL_CURE = 30, // used
    ABILITY_LIGHTNING_ROD = 31, // used
    ABILITY_SERENE_GRACE = 32, // used
    ABILITY_SWIFT_SWIM = 33, // used
    ABILITY_CHLOROPHYLL = 34, // used
    ABILITY_ILLUMINATE = 35, // NOT USED
    ABILITY_TRACE = 36, // used
    ABILITY_HUGE_POWER = 37, // used
    ABILITY_POISON_POINT = 38, // used
    ABILITY_INNER_FOCUS = 39, // used
    ABILITY_MAGMA_ARMOR = 40, // NOT USED
    ABILITY_WATER_VEIL = 41, // NOT USED
    ABILITY_MAGNET_PULL = 42, // NOT USED
    ABILITY_SOUNDPROOF = 43, // NOT USED
    ABILITY_RAIN_DISH = 44, // NOT USED
    ABILITY_SAND_STREAM = 45, // used
    ABILITY_PRESSURE = 46, // used
    ABILITY_THICK_FAT = 47, // used
    ABILITY_EARLY_BIRD = 48, // NOT USED
    ABILITY_FLAME_BODY = 49, // used
    ABILITY_RUN_AWAY = 50, // NOT USED
    ABILITY_KEEN_EYE = 51, // NOT USED
    ABILITY_HYPER_CUTTER = 52, // used
    ABILITY_PICKUP = 53, // NOT USED
    ABILITY_TRUANT = 54, // used
    ABILITY_HUSTLE = 55, // used
    ABILITY_CUTE_CHARM = 56, // NOT USED
    ABILITY_PLUS = 57, // used
    ABILITY_MINUS = 58, // used
    ABILITY_FORECAST = 59, // NOT USED
    ABILITY_STICKY_HOLD = 60, // used
    ABILITY_SHED_SKIN = 61, // NOT USED
    ABILITY_GUTS = 62, // used
    ABILITY_MARVEL_SCALE = 63, // used
    ABILITY_LIQUID_OOZE = 64, // NOT USED
    ABILITY_OVERGROW = 65, // used
    ABILITY_BLAZE = 66, // used
    ABILITY_TORRENT = 67, // used
    ABILITY_SWARM = 68, // used
    ABILITY_ROCK_HEAD = 69, // used
    ABILITY_DROUGHT = 70, // used
    ABILITY_ARENA_TRAP = 71, // used
    ABILITY_VITAL_SPIRIT = 72, // NOT USED
    ABILITY_WHITE_SMOKE = 73, // NOT USED
    ABILITY_PURE_POWER = 74, // used
    ABILITY_SHELL_ARMOR = 75, // used
    ABILITY_AIR_LOCK = 76, // used
    ABILITIES_COUNT_GEN3,

    // Gen 4
    ABILITY_TANGLED_FEET = ABILITIES_COUNT_GEN3,
    ABILITY_MOTOR_DRIVE = 78, // NOT USED
    ABILITY_RIVALRY = 79, // NOT USED
    ABILITY_STEADFAST = 80, // used
    ABILITY_SNOW_CLOAK = 81, // used
    ABILITY_GLUTTONY = 82, // used
    ABILITY_ANGER_POINT = 83, // used
    ABILITY_UNBURDEN = 84, // used
    ABILITY_HEATPROOF = 85, // NOT USED
    ABILITY_SIMPLE = 86, // used
    ABILITY_DRY_SKIN = 87, // used
    ABILITY_DOWNLOAD = 88, // used
    ABILITY_IRON_FIST = 89, // used
    ABILITY_POISON_HEAL = 90, // used
    ABILITY_ADAPTABILITY = 91, // used
    ABILITY_SKILL_LINK = 92, // used
    ABILITY_HYDRATION = 93, // used
    ABILITY_SOLAR_POWER = 94, // used
    ABILITY_QUICK_FEET = 95, // used
    ABILITY_NORMALIZE = 96, // NOT USED
    ABILITY_SNIPER = 97, // used
    ABILITY_MAGIC_GUARD = 98, // NOT USED
    ABILITY_NO_GUARD = 99, // used
    ABILITY_STALL = 100, // NOT USED
    ABILITY_TECHNICIAN = 101, // used
    ABILITY_LEAF_GUARD = 102, // NOT USED
    ABILITY_KLUTZ = 103, // NOT USED
    ABILITY_MOLD_BREAKER = 104, // used
    ABILITY_MOLDBREAKER = ABILITY_MOLD_BREAKER, // used
    ABILITY_SUPER_LUCK = 105, // used
    ABILITY_AFTERMATH = 106,
    ABILITY_ANTICIPATION = 107, // NOT USED
    ...
    ABILITY_HAIL_WARNING = ABILITIES_COUNT_GEN9,
    ABILITY_SNOW_FORCE = 320,
    ABILITY_FROST_BODY = 321,
    ABILITIES_COUNT,
};
