...
#define BATTLE_TYPE_TWO_PLAYER         (1 << 14)
...
#define BATTLE_TYPE_HAS_AI                  (BATTLE_TYPE_TRAINER | BATTLE_TYPE_FIRST_BATTLE | BATTLE_TYPE_SAFARI | BATTLE_TYPE_ROAMER | BATTLE_TYPE_INGAME_PARTNER | BATTLE_TYPE_RAYQUAZA)
