...
#define BATTLE_TYPE_CUSTOM             (1 << 32) // Battles where player, partner, and opponent can be in any battle position
...
#define BATTLE_TWO_VS_ONE_OPPONENT          ((gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER && TRAINER_BATTLE_PARAM.battler3 == 0xFFFF))
