...
#define SIDE_STATUS_SPIKES                  (1 << 12)
...
enum StartingStatus
{
    ...
    STARTING_STATUS_SPIKES_PLAYER_1,
    STARTING_STATUS_SPIKES_PLAYER_2,
    STARTING_STATUS_SPIKES_PLAYER_3,
    STARTING_STATUS_SPIKES_OPPONENT_1,
    STARTING_STATUS_SPIKES_OPPONENT_2,
    STARTING_STATUS_SPIKES_OPPONENT_3,
};
