...
// HNS flags defined to zero

#define FLAG_ENABLE_CONDITION 0
#define FLAG_ITEM_ICEPATH4_TM_AVALANCHE 0
#define FLAG_ITEM_VICTORYROAD1_TM_EARTHQUAKE 0
#define FLAG_DEFEATED_RED 0
#define FLAG_STARTER_PREVIEW_CHECKED_1 0
#define FLAG_SHINY_STARTER_1 0
#define FLAG_STARTER_PREVIEW_CHECKED_2 0
#define FLAG_SHINY_STARTER_2 0
#define FLAG_STARTER_PREVIEW_CHECKED_3 0
#define FLAG_SHINY_STARTER_3 0
#define FLAG_FINITE_TMS 0
#define FLAG_SYS_BUG_CONTEST_MODE 0
#define FLAG_IN_KANTO_SAFARI_ZONE 0
#define FLAG_MOM_HAS_GIFT 0
#define FLAG_GET_HEADBUTT 0
