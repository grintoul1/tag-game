...
enum StringID
{
    ...
    STRINGID_PKMNMENTALHERBPREVENTEDFLINCHING,
    ...
    STRINGID_INVERSIONPOLICYSTARTS,
    STRINGID_INVERSIONPOLICYENDS,
    STRINGID_DISTRACTIONPOLICYSTARTS,
    STRINGID_DISTRACTIONPOLICYENDS,
    STRINGID_SPOTLIGHTPOLICYSTARTS,
    STRINGID_SPOTLIGHTPOLICYENDS,
