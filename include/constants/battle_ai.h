...
#define AI_FLAG_PARTNER_SWITCHING           (1 << 29)  // Partner switching
...
#define AI_FLAG_SMART_TRAINER         (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_POWERFUL_STATUS | AI_FLAG_WILL_SUICIDE)
#define AI_FLAG_PREDICTION            (AI_FLAG_PREDICT_SWITCH | AI_FLAG_PREDICT_INCOMING_MON | AI_FLAG_PREDICT_MOVE)
#define AI_FLAG_PARTNER_TRAINER       (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_PARTNER_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_POWERFUL_STATUS | AI_FLAG_WILL_SUICIDE)
