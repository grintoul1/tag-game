...
#define PARTY_LAYOUT_MIRROR                         8  // The layout during the screen that appears just before Emmie mirror battle
#define PARTY_LAYOUT_MULTI_SHARED                   9
#define PARTY_LAYOUT_OVERWORLD                      10
#define PARTY_LAYOUT_OVERWORLD_SHARED               11
#define PARTY_LAYOUT_COUNT                          12
...
#define PARTY_MENU_TYPE_MULTI_FULL_SHOWCASE       18
#define PARTY_MENU_TYPE_CHOOSE_STORY              19
