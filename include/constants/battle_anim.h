...
#define ANIM_TAG_BLAST_BURN_BALL            (ANIM_SPRITES_START + 416)
#define ANIM_TAG_HYDRO_CANNON_BALL          (ANIM_SPRITES_START + 417)
#define ANIM_TAG_FRENZY_PLANT_BALL          (ANIM_SPRITES_START + 418)
#define ANIM_TAG_TRI_ATTACK_2_TRIANGLE      (ANIM_SPRITES_START + 419)
#define ANIM_TAG_TRUCK_ATTACK_TRIANGLE      (ANIM_SPRITES_START + 420)
#define ANIM_TAG_COUNT                      GET_TRUE_SPRITE_INDEX(ANIM_TAG_TRUCK_ATTACK_TRIANGLE + 1)
