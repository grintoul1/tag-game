...
enum ShouldSwitchScenario
{
    ...
    SHOULD_PARTNER_SWITCH_WONDER_GUARD,
    SHOULD_PARTNER_SWITCH_ABSORBS_MOVE,
    SHOULD_PARTNER_SWITCH_TRAPPER,
    SHOULD_PARTNER_SWITCH_FREE_TURN,
    SHOULD_PARTNER_SWITCH_TRUANT,
    SHOULD_PARTNER_SWITCH_ALL_MOVES_BAD,
    SHOULD_PARTNER_SWITCH_PERISH_SONG,
    SHOULD_PARTNER_SWITCH_YAWN,
    SHOULD_PARTNER_SWITCH_BADLY_POISONED,
    SHOULD_PARTNER_SWITCH_BADLY_POISONED_STATS_RAISED,
    SHOULD_PARTNER_SWITCH_CURSED,
    SHOULD_PARTNER_SWITCH_CURSED_STATS_RAISED,
    SHOULD_PARTNER_SWITCH_NIGHTMARE,
    SHOULD_PARTNER_SWITCH_NIGHTMARE_STATS_RAISED,
    SHOULD_PARTNER_SWITCH_SEEDED,
    SHOULD_PARTNER_SWITCH_SEEDED_STATS_RAISED,
    SHOULD_PARTNER_SWITCH_INFATUATION,
    SHOULD_PARTNER_SWITCH_HASBADODDS,
    SHOULD_PARTNER_SWITCH_NATURAL_CURE_STRONG,
    SHOULD_PARTNER_SWITCH_NATURAL_CURE_STRONG_STATS_RAISED,
    SHOULD_PARTNER_SWITCH_NATURAL_CURE_WEAK,
    SHOULD_PARTNER_SWITCH_NATURAL_CURE_WEAK_STATS_RAISED,
    SHOULD_PARTNER_SWITCH_REGENERATOR,
    SHOULD_PARTNER_SWITCH_REGENERATOR_STATS_RAISED,
    SHOULD_PARTNER_SWITCH_ENCORE_STATUS,
    SHOULD_PARTNER_SWITCH_ENCORE_DAMAGE,
    SHOULD_PARTNER_SWITCH_CHOICE_LOCKED,
    SHOULD_PARTNER_SWITCH_ATTACKING_STAT_MINUS_TWO,
    SHOULD_PARTNER_SWITCH_ATTACKING_STAT_MINUS_THREE_PLUS,
    SHOULD_PARTNER_SWITCH_ALL_SCORES_BAD,
};
...
struct SwitchAiContext
{
    ...
    enum BattlerId battlerPartner:3;
    enum BattlerId opposingPartner:3;
