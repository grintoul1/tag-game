...
enum MugshotColor
{
    ...
    MUGSHOT_COLOR_RED,
    MUGSHOT_COLOR_ARCHIEWITHMAXIE,
    MUGSHOT_COLOR_AQUAMAGMA,
    MUGSHOT_COLOR_ORANGE,
    MUGSHOT_COLOR_DRAKE,
    MUGSHOT_COLOR_BROWN,
    MUGSHOT_COLOR_BLACK,
    MUGSHOT_COLOR_GREY,
    MUGSHOT_COLOR_WHITE,
    MUGSHOT_COLOR_CHAMPION,
    MUGSHOT_COLOR_DARKPURPLE,
    MUGSHOT_COLOR_GREEN,
    MUGSHOT_COLOR_PINK,
    MUGSHOT_COLOR_EMMIEWITHSHELLY,
    MUGSHOT_COLOR_MAYPINK,
    MUGSHOT_COLOR_BLUE,
    MUGSHOT_COLOR_MISTY,
    MUGSHOT_COLOR_MAXIEWITHARCHIE,
    MUGSHOT_COLOR_LIGHTBLUE,
    MUGSHOT_COLOR_YELLOW,
    MUGSHOT_COLOR_BRENDAN,
    MUGSHOT_COLOR_MAY,
    MUGSHOT_COLOR_TATE,
    MUGSHOT_COLOR_LIZA,
    MUGSHOT_COLOR_SABRINA,
    MUGSHOT_COLOR_TATE_AND_LIZA,
    MUGSHOT_COLOR_LIZA_AND_TATE,
    MUGSHOT_COLOR_SABRINA_AND_TATE,
    MUGSHOT_COLOR_TATE_AND_SABRINA,
    MUGSHOT_COLOR_LIZA_AND_SABRINA,
    MUGSHOT_COLOR_SABRINA_AND_LIZA,
    MUGSHOT_COLOR_COUNT
};
...
enum BattleTransition
{
    ...
    B_TRANSITION_AQUA_MAGMA,
    B_TRANSITION_BLUR_BRIGHTEN,
    B_TRANSITION_RAYQUAZA_TAG,
    B_TRANSITION_COUNT
};
