...
{
    return (gBattleTypeFlags & BATTLE_TYPE_DOUBLE || gBattleTypeFlags & BATTLE_TYPE_MULTI || gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER || gBattleTypeFlags & BATTLE_TYPE_TWO_OPPONENTS);
}
