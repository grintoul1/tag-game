...
#define WININ_WIN2_BG0      (1 << 14)
#define WININ_WIN2_BG1      (1 << 15)
#define WININ_WIN2_BG2      (1 << 16)
#define WININ_WIN2_BG3      (1 << 17)
#define WININ_WIN2_BG_ALL   (WININ_WIN2_BG0 | WININ_WIN2_BG1 | WININ_WIN2_BG2 | WININ_WIN2_BG3)
#define WININ_WIN2_OBJ      (1 << 18)
#define WININ_WIN2_CLR      (1 << 19)
#define WININ_WIN2_ALL      (WININ_WIN2_BG_ALL | WININ_WIN2_OBJ | WININ_WIN2_CLR)
#define WININ_WIN3_BG0      (1 << 20)
#define WININ_WIN3_BG1      (1 << 21)
#define WININ_WIN3_BG2      (1 << 22)
#define WININ_WIN3_BG3      (1 << 23)
#define WININ_WIN3_BG_ALL   (WININ_WIN3_BG0 | WININ_WIN3_BG1 | WININ_WIN3_BG2 | WININ_WIN3_BG3)
#define WININ_WIN3_OBJ      (1 << 24)
#define WININ_WIN3_CLR      (1 << 25)
#define WININ_WIN3_ALL      (WININ_WIN3_BG_ALL | WININ_WIN3_OBJ | WININ_WIN3_CLR)
