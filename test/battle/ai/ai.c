...
AI_MULTI_BATTLE_TEST("AI thinking time doesn't explode (12v12)")
{
    KNOWN_FAILING;
    GIVEN {
        BATTLER_AI_FLAGS(playerRight, AI_FLAG_BASIC_TRAINER);
...
AI_MULTI_BATTLE_TEST("AI thinking time doesn't explode (12v12, smart)")
{
    KNOWN_FAILING;
    GIVEN {
        BATTLER_AI_FLAGS(playerRight, AI_FLAG_SMART_TRAINER);
...
AI_SINGLE_BATTLE_TEST("FIXER AI's comparison of damaging moves correctly reads moveset indexes for effects")
{
    KNOWN_FAILING; // FIXER (should just be scores)
    u32 move = MOVE_NONE;
