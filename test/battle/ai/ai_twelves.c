...
AI_MULTI_BATTLE_TEST("12v12: AI can use all 6 party slots in a 12v12 (battler 1)")
{
    GIVEN {
        ...
        PARTNER(SPECIES_ABRA) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
        PARTNER(SPECIES_KADABRA) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
        PARTNER(SPECIES_ALAKAZAM) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
        ...
        OPPONENT_A(SPECIES_ABRA) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        OPPONENT_A(SPECIES_KADABRA) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        OPPONENT_A(SPECIES_ALAKAZAM) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        ...
        OPPONENT_B(SPECIES_ABRA) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
        OPPONENT_B(SPECIES_KADABRA) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
        OPPONENT_B(SPECIES_ALAKAZAM) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
...
AI_MULTI_BATTLE_TEST("12v12: AI can use all 6 party slots in a 12v12 (battler 2)")
{
    GIVEN {
        ...
        PARTNER(SPECIES_ABRA) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        PARTNER(SPECIES_KADABRA) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        PARTNER(SPECIES_ALAKAZAM) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        ...
        OPPONENT_A(SPECIES_ABRA) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
        OPPONENT_A(SPECIES_KADABRA) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
        OPPONENT_A(SPECIES_ALAKAZAM) { Ability(ABILITY_INNER_FOCUS); Moves(MOVE_CELEBRATE); }
...
AI_MULTI_BATTLE_TEST("12v12: AI can use all 6 party slots in a 12v12 (battler 3)")
{
    GIVEN {
        ...
        OPPONENT_B(SPECIES_ABRA) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        OPPONENT_B(SPECIES_KADABRA) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
        OPPONENT_B(SPECIES_ALAKAZAM) { Moves(MOVE_CELEBRATE); HP(1); Status1(STATUS1_POISON); Ability(ABILITY_INNER_FOCUS); }
