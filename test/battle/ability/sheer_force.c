...
static inline bool32 IsMoveSheerForceBoosted(enum Move move)
{
    switch (move) {
        ...
        case MOVE_FROST_FANG:
        case MOVE_FROSTY_GALE:
        case MOVE_FROST_PUNCH:
        case MOVE_GUNK_SHOT:
        case MOVE_HEADBUTT:
        case MOVE_HEAT_WAVE:
        case MOVE_HURRICANE:
...
AI_SINGLE_BATTLE_TEST("AI sees Sheer Force skips additional effects")
{
    ...
    PARAMETRIZE { ability = ABILITY_ROUGH_SKIN;  move = MOVE_KARATE_CHOP; expectedMove = MOVE_KARATE_CHOP;      }
