...
{
    struct Pokemon egg;
    CreateMonWithIVs(&egg, SPECIES_BULBASAUR, 1, Random32(), OTID_STRUCT_PLAYER_ID, 0, FALSE);
...
{
    struct Pokemon egg;
    CreateMonWithIVs(&egg, SPECIES_ABRA, 1, Random32(), OTID_STRUCT_PLAYER_ID, 0, FALSE);
    u32 value = 3;
