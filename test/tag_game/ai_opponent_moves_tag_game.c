...
/*AI_MULTI_BATTLE_TEST("TAG TEST: MULTI: AI: OPPONENT: SCORING: Opponents choose priority last chance move over slow KO 90% of the time")
{
    ...
    GIVEN {
        ...
        MULTI_PLAYER(SPECIES_VESPIQUEN) { HP(150); Speed(3); }
        MULTI_PARTNER(SPECIES_VESPIQUEN) { HP(100); Moves(MOVE_NIGHT_SHADE, MOVE_CELEBRATE); Speed(3); }
        MULTI_OPPONENT_A(SPECIES_WOBBUFFET) { HP(30); Moves(MOVE_NIGHT_SHADE, MOVE_MACH_PUNCH); Speed(1); };
        MULTI_OPPONENT_B(SPECIES_WOBBUFFET) { HP(30); Moves(MOVE_NIGHT_SHADE, MOVE_MACH_PUNCH); Speed(2); };
    } WHEN {
...
AI_TWO_VS_ONE_BATTLE_TEST("TAG TEST: 2VS1: AI: OPPONENT: SCORING: Opponents choose priority last chance move over slow KO 90% of the time")
{
    ...
    GIVEN {
        ...
        MULTI_PARTNER(SPECIES_VESPIQUEN) { HP(100); Moves(MOVE_NIGHT_SHADE, MOVE_CELEBRATE); Speed(3); }
        MULTI_OPPONENT_A(SPECIES_WOBBUFFET) { HP(30); Moves(MOVE_NIGHT_SHADE, MOVE_MACH_PUNCH); Speed(1); };
        MULTI_OPPONENT_A(SPECIES_WOBBUFFET) { HP(30); Moves(MOVE_NIGHT_SHADE, MOVE_MACH_PUNCH); Speed(2); };
    } WHEN {
            TURN { MOVE(playerRight, MOVE_CELEBRATE); EXPECT_MOVE(opponentRight, MOVE_MACH_PUNCH, target:playerRight); }
        } 
}*/
