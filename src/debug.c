...
static void DebugAction_PCBag_Fill_PCBoxes_Fast(u8 taskId) //Credit: Sierraffinity
{
    ...
    CreateBoxMon(&boxMon, species, 100, Random32(), OTID_STRUCT_PLAYER_ID, FALSE);
...
#define SOUND_LIST_BGM              \
    ...
    X(MUS_DANCE_THEATRE)    \
    X(MUS_DRAGONS_DEN)    \
    X(MUS_DRAGONSPIRAL_TOWER)    \
    X(MUS_DREAMYARD)    \
    X(MUS_DRIFTVEIL_CITY)    \
    X(MUS_ECRUTEAK_CITY)    \
    X(MUS_ENCOUNTER_GALACTIC_GRUNT)    \
    X(MUS_ENCOUNTER_HOOH)    \
    X(MUS_ENCOUNTER_KIMONO_GIRL)    \
    X(MUS_ENCOUNTER_LOOKER)    \
    X(MUS_ENCOUNTER_LUGIA)    \
    X(MUS_ENCOUNTER_TEAM_PLASMA)    \
    X(MUS_ENCOUNTER_TEAM_PLASMA_2)    \
    X(MUS_ETERNA_CITY)    \
    X(MUS_ETERNA_FOREST)    \
    X(MUS_FLOAROMA_TOWN)    \
    X(MUS_FLOCCESY_TOWN)    \
    ...
    X(MUS_GREAT_CANYON)    \
    X(MUS_HUMILAU_GYM)    \
    X(MUS_JOHTO_ROUTE_29)    \
    X(MUS_JOHTO_ROUTE_30)    \
    X(MUS_JOHTO_ROUTE_34)    \
    X(MUS_JUBILIFE_CITY)    \
    X(MUS_JUBILIFE_VILLAGE)    \
    X(MUS_LAVENDER_TOWN)    \
    X(MUS_MEZAGOZA)    \
    X(MUS_MIROR_B)    \
    X(MUS_MISTRALTON_CITY)    \
    X(MUS_MT_CORONET)    \
    X(MUS_N_FAREWELL)    \
    X(MUS_N_FINAL_BATTLE)    \
    X(MUS_OLD_CHATEAU)    \
    X(MUS_OPELUCID_CITY)    \
    X(MUS_OREBURGH_CITY)    \
    X(MUS_ROWANS_LAB)    \
    X(MUS_SINJOH_RUINS)    \
    X(MUS_SINNOH_LAKE)    \
    X(MUS_SINNOH_PKMN_LEAGUE_EXTERIOR)    \
    X(MUS_SINNOH_PKMN_LEAGUE_INTERIOR)    \
    X(MUS_SINNOH_ROUTE_205)    \
    X(MUS_SINNOH_ROUTE_210)    \
    X(MUS_SINNOH_ROUTE_213)    \
    X(MUS_SKY_TOWER)    \
    X(MUS_STRANGE_HOUSE)    \
    X(MUS_SUNNYSHORE_CITY)    \
    X(MUS_TWINLEAF_TOWN)    \
    X(MUS_UNOVA_GYM)    \
    X(MUS_UNOVA_ROUTE_4)    \
    X(MUS_UNOVA_ROUTE_6)    \
    X(MUS_UNWAVERING_EMOTIONS)    \
    X(MUS_VEILSTONE_CITY)    \
    X(MUS_VICTORY_GALACTIC_GRUNT)    \
    X(MUS_VICTORY_POKEMON_SINNOH)    \
    X(MUS_VICTORY_UNOVA_LEADER)    \
    X(MUS_VICTORY_WILD_POKEMON)    \
    X(MUS_VS_CIPHER_PEON)    \
    X(MUS_VS_COLOSSEUM_ROUND_3)    \
    X(MUS_VS_CYRUS)    \
    X(MUS_VS_ENTEI)    \
    X(MUS_VS_FINAL_POKEMON)    \
    X(MUS_VS_GALACTIC_GRUNT)    \
    X(MUS_VS_GHETSIS)    \
    X(MUS_VS_GIRATINA)    \
    X(MUS_VS_HOOH)    \
    X(MUS_VS_IRIS)    \
    X(MUS_VS_JOHTO_LEADER)    \
    X(MUS_VS_JOHTO_TRAINER)    \
    X(MUS_VS_KANTO_TRAINER)    \
    X(MUS_VS_LUGIA)    \
    X(MUS_VS_POKEMON_AREA_ZERO)    \
    X(MUS_VS_POKEMON_JOHTO)    \
    X(MUS_VS_POKEMON_KANTO)    \
    X(MUS_VS_POKEMON_UNOVA)    \
    X(MUS_VS_RAIKOU)    \
    X(MUS_VS_ROAMING_LEGENDARY)    \
    X(MUS_VS_ROCKET)    \
    X(MUS_VS_SILVER)    \
    X(MUS_VS_SINNOH_TRAINER)    \
    X(MUS_VS_SUICUNE)    \
    X(MUS_VS_UNOVA_ELITE_FOUR)    \
    X(MUS_VS_UNOVA_LEADER)    \
    X(MUS_VS_UNOVA_RIVAL)    \
    X(MUS_VS_UNOVA_TRAINER)    \
    X(MUS_GS_1)    \
    X(MUS_GS_10)    \
    X(MUS_GS_12)    \
    X(MUS_GS_27)    \
    ...
    X(MUS_GS_BATTLE2)    \
    X(MUS_GS_BATTLE3)    \
    X(MUS_GS_VS_JOHTO_LEADER)    \
    X(MUS_GS_BATTLE5)    \
    X(MUS_GS_BATTLE6)    \
    X(MUS_GS_BATTLE7)    \
    X(MUS_GS_BATTLE8)    \
    X(MUS_GS_VS_KANTO_LEADER)    \
    X(MUS_GS_BIKE)    \
    X(MUS_GS_CAUGHT)    \
    X(MUS_GS_CAVE1)    \
    X(MUS_GS_CAVE2)    \
    X(MUS_GS_CELADON)    \
    X(MUS_GS_CENTER)    \
    X(MUS_GS_CHERRYGROVE)    \
    X(MUS_GS_CONTEST)    \
    X(MUS_GS_CORNER)    \
    X(MUS_GS_CORNERLEAVE)    \
    X(MUS_GS_CREDITS)    \
    X(MUS_GS_DANCE)    \
    X(MUS_GS_DELETE)    \
    X(MUS_GS_DEN)    \
    ...
    X(MUS_GS_VS_KANTO_LEADER_BLAINE)     \
    X(MUS_GS_VS_KANTO_LEADER_JANINE_KOGA)     \
    X(MUS_GS_VS_KANTO_LEADER_ERIKA)     \
    X(MUS_GS_VS_KANTO_LEADER_MISTY_SURGE)     \
    X(MUS_GS_VS_KANTO_LEADER_SABRINA)     \
    X(MUS_GS_VS_KANTO_LEADER_BROCK)     \
    X(MUS_COLOSSEUM_BATTLE_FANFARE_1_V1_1)     \
    X(MUS_COLOSSEUM_BATTLE_FANFARE_1)     \
    X(MUS_COLOSSEUM_PYRITE_TOWN)     \
    X(MUS_COLOSSEUM_RELIC_STONE_SHRINE)     \
    X(MUS_COLOSSEUM_STORY_MODE_NORMAL_BATTLE_ARRANGED)     \
    X(MUS_COLOSSEUM_VS_CIPHER_ADMIN)     \
    X(MUS_COLOSSEUM_VS_MIROR_B)     \
    X(MUS_COLOSSEUM_AGB_FANFA1B)    \
    X(MUS_COLOSSEUM_AGB_FANFA5)     \
    X(MUS_COLOSSEUM_AGB_ME_ASA)     \
    X(MUS_COLOSSEUM_AGB_ME_SHINKA)  \
    X(MUS_COLOSSEUM_AGB_SHINKA)     \
    X(MUS_COLOSSEUM_BATTLE2)        \
    X(MUS_COLOSSEUM_BATTLE5)        \
    X(MUS_COLOSSEUM_BATTLE6)        \
    X(MUS_COLOSSEUM_BATTLE7)        \
    X(MUS_COLOSSEUM_BATTLE8)        \
    X(MUS_COLOSSEUM_BATTLE9)        \
    X(MUS_COLOSSEUM_BATTLE9PLUS)    \
    X(MUS_COLOSSEUM_CHAKUMELO00)    \
    X(MUS_COLOSSEUM_CHAKUMELO01)    \
    X(MUS_COLOSSEUM_CHAKUMELO02)    \
    X(MUS_COLOSSEUM_CHAKUMELO03)    \
    X(MUS_COLOSSEUM_CHAKUMELO04)    \
    X(MUS_COLOSSEUM_CHAKUMELO05)    \
    X(MUS_COLOSSEUM_CHAKUMELO06)    \
    X(MUS_COLOSSEUM_CHAKUMELO07)    \
    X(MUS_COLOSSEUM_CHAKUMELO08)    \
    X(MUS_COLOSSEUM_CHAKUMELO09)    \
    X(MUS_COLOSSEUM_COUNTRY)        \
    X(MUS_COLOSSEUM_DARKSIDE4)      \
    X(MUS_COLOSSEUM_DARKSIDE)       \
    X(MUS_COLOSSEUM_DARKUNDER)      \
    X(MUS_COLOSSEUM_DEMO_ROLL)      \
    X(MUS_COLOSSEUM_DUNGEON)        \
    X(MUS_COLOSSEUM_END_EV_1)       \
    X(MUS_COLOSSEUM_END_EV_2)       \
    X(MUS_COLOSSEUM_END_ROLL_B)     \
    X(MUS_COLOSSEUM_END_ROLL_C)     \
    X(MUS_COLOSSEUM_EV_KINPAKU)     \
    X(MUS_COLOSSEUM_EV_SHADOW)      \
    X(MUS_COLOSSEUM_EV_SHICCHO)     \
    X(MUS_COLOSSEUM_EV_SNATCH)      \
    X(MUS_COLOSSEUM_FANFARE00)      \
    X(MUS_COLOSSEUM_FANFARE01)      \
    X(MUS_COLOSSEUM_FANFARE02)      \
    X(MUS_COLOSSEUM_FANFARE03)      \
    X(MUS_COLOSSEUM_GS_LOGO)        \
    X(MUS_COLOSSEUM_GTSOLO)         \
    X(MUS_COLOSSEUM_HYPER_SHICCHO)  \
    X(MUS_COLOSSEUM_JYAKIRA)        \
    X(MUS_COLOSSEUM_LEVEL_UP)       \
    X(MUS_COLOSSEUM_ME_CHUKEI)      \
    X(MUS_COLOSSEUM_ME_EX_TRE)      \
    X(MUS_COLOSSEUM_ME_FUE)         \
    X(MUS_COLOSSEUM_ME_NEWS)        \
    X(MUS_COLOSSEUM_ME_RELIVE)      \
    X(MUS_COLOSSEUM_ME_SNATCH)      \
    X(MUS_COLOSSEUM_ME_UNDERTIME)   \
    X(MUS_COLOSSEUM_ME_WELCOME)     \
    X(MUS_COLOSSEUM_ME_WIN)         \
    X(MUS_COLOSSEUM_ME_WINWIN)      \
    X(MUS_COLOSSEUM_MIRACLEBO)      \
    X(MUS_COLOSSEUM_MIRRORBO)       \
    X(MUS_COLOSSEUM_MT_BATTLE)      \
    X(MUS_COLOSSEUM_NULL_BGM)       \
    X(MUS_COLOSSEUM_OPEN_ROLL)      \
    X(MUS_COLOSSEUM_POKECEN)        \
    X(MUS_COLOSSEUM_SAINT)          \
    X(MUS_COLOSSEUM_SHINPI)         \
    X(MUS_COLOSSEUM_SIREN_ATMOS)    \
    X(MUS_COLOSSEUM_STAND2)         \
    X(MUS_COLOSSEUM_STAND)          \
    X(MUS_COLOSSEUM_TITLE)          \
    X(MUS_COLOSSEUM_TOOL_BATTLE1)   \
    X(MUS_COLOSSEUM_TOOL_BATTLE2)   \
    X(MUS_COLOSSEUM_TOOL_BATTLE3)   \
    X(MUS_COLOSSEUM_TOOL_MUSIC)     \
    X(MUS_COLOSSEUM_TRETRE)         \
    X(MUS_COLOSSEUM_VIRTUAL)        \
    X(MUS_COLOSSEUM_WATERCITY)      \
    X(MUS_COLOSSEUM_WIND_ATMOS_LOOP) \
    X(MUS_COLOSSEUM_WINDYCITY)      \
    X(MUS_COLOSSEUM_WORLDMAP2)      \
    X(MUS_COLOSSEUM_WORLDMAP)       \
    X(MUS_PMD_VS_DIALGA)            \
    X(MUS_HG_ROUTE47)               \
    X(MUS_DP_ROUTE_216)             \
    X(MUS_DP_SNOWPOINT)             \
    X(MUS_UNOVA_ROUTE_22)           \
    X(MUS_UNOVA_ABYSSAL_RUINS)      \
    X(MUS_UNOVA_ROUTE_23)           \
    X(MUS_UNOVA_ROUTE_1)            \
    X(MUS_UNOVA_ROUTE_10)           \
    X(MUS_UNOVA_FIRST_DAY)          \
    X(MUS_DP_ROUTE_201)             \
    X(MUS_UNOVA_HUMILAU_CITY)       \
    X(MUS_HG_ROUTE26)               \
    X(MUS_UNOVA_ANVILLE_TOWN)       \
    X(MUS_HG_CHERRYGROVE)           \
    X(MUS_UNOVA_LOSTORN_FOREST)     \
    X(MUS_UNOVA_LACONUSA_TOWN)      \
    X(MUS_UNOVA_ASPERTIA_CITY)      \
    X(MUS_UNOVA_CHARGESTONE_CAVE)   \
    X(MUS_FLOCCESY_RANCH)           \
    ...
    X(MUS_PMD_WIGGLYTUFFS_GUILD)    \
    X(MUS_PMD_AT_THE_END_OF_THE_DAY)    \
    X(MUS_PMD_TEMPORAL_TOWER)    \
    X(MUS_PMD_THROUGH_THE_SEA_OF_TIME)    \
    X(MUS_PMD_FOGGY_FOREST)    \
    X(MUS_PMD_A_WISH_FOR_PEACE)    \
    X(MUS_PMD_JOB_CLEAR)    \
    X(MUS_PMD_CRAGGY_COAST)    \
    X(MUS_PMD_DEEP_DARK_CRATER)    \
    X(MUS_PMD_ON_THE_BEACH_AT_DUSK)    \
    X(MUS_PMD_TOP_MENU_THEME)    \
    X(MUS_PMD_TIME_GEAR)    \
    X(MUS_PMD_HEARTWARMING)    \
    X(MUS_PMD_TREASURE_TOWN)    \
    X(MUS_PMD_DRENCHED_BLUFF)    \
    X(MUS_PMD_APPLE_WOODS)    \
    X(MUS_PMD_SOUTHERN_JUNGLE)    \
    X(MUS_PMD_DO_YOUR_BEST_AS_ALWAYS)    \
    X(MUS_PMD_KECLEONS_SHOP)    \
    X(MUS_PMD_GOODNIGHT)    \
    X(MUS_PMD_SPACIAL_CLIFFS)    \
    X(MUS_PMD_TEMPORAL_SPIRE)    \
    X(MUS_PMD_WIGGLYTUFFS_GUILD_REMIX)    \
    X(MUS_PMD_PELIPPER_ISLAND)    \
    X(MUS_PMD_SKY_PEAK_FOREST)    \
    X(MUS_PMD_ENDING_THEME)    \
    X(MUS_PMD_HIDDEN_LAND)    \
    X(MUS_PMD_SHAYMIN_VILLAGE)    \
    X(MUS_PMD_ILLUSION_STONE_CHAMBER)    \
    X(MUS_PMD_FAR_AMP_PLAINS)    \
    X(MUS_PMD_IN_THE_FUTURE)    \
    X(MUS_PMD_A_FUN_EXPLORATION)    \
