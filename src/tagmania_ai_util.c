...
enum AIScore IncreaseStatDownScore(enum BattlerId battlerAtk, enum BattlerId battlerDef, enum Stat stat)
{
    ...
    u32 noOfHitsToFaint = NoOfHitsForTargetToFaintBattler(battlerDef, battlerAtk, AI_DEFENDING, DONT_CONSIDER_ENDURE);
    u32 noOfHitsToFaintTarget = NoOfHitsForTargetToFaintBattler(battlerAtk, battlerDef, AI_ATTACKING, DONT_CONSIDER_ENDURE);
