...
static const mapsec_u16_t sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_SHOAL_CAVITY_UNDERWATER,    MAPSEC_SHOAL_CAVITY},
    {MAPSEC_SHOAL_CAVERN_UNDERWATER,    MAPSEC_SHOAL_CAVERN},
    {MAPSEC_SHOAL_HOLLOW_UNDERWATER,    MAPSEC_SHOAL_HOLLOW},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_100] = {MAP_GROUP(MAP_ROUTE100), MAP_NUM(MAP_ROUTE100), HEAL_LOCATION_NONE},
