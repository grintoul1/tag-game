...
static void PrepareOneTrainer(bool8 difficult)
{
    ...
    if (gSaveBlock2Ptr->frontier.curChallengeBattleNum < NUM_PIKE_ROOMS)
        gSaveBlock2Ptr->frontier.trainerIds[gSaveBlock2Ptr->frontier.curChallengeBattleNum - 1] = TRAINER_BATTLE_PARAM.battler1;
}
...
static void PrepareTwoTrainers(void)
{
    ...
    TRAINER_BATTLE_PARAM.battler3 = trainerId;
    SetBattleFacilityTrainerGfxId(TRAINER_BATTLE_PARAM.battler3, 1);
    if (gSaveBlock2Ptr->frontier.curChallengeBattleNum < NUM_PIKE_ROOMS)
        gSaveBlock2Ptr->frontier.trainerIds[gSaveBlock2Ptr->frontier.curChallengeBattleNum - 2] = TRAINER_BATTLE_PARAM.battler3;
}
...
static void BufferTrainerIntro(void)
{
    ...
    {
        if (TRAINER_BATTLE_PARAM.battler3 < FRONTIER_TRAINERS_COUNT)
            FrontierSpeechToString(gFacilityTrainers[TRAINER_BATTLE_PARAM.battler3].speechBefore);
    }
}
