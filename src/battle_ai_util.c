...
void SwapBattlerAiFlags(u32 battler1, u32 battler2)
{
    ...
    gAiThinkingStruct->aiFlags[battler1] = gAiThinkingStruct->aiFlags[battler2];
    gAiThinkingStruct->aiFlags[battler2] = tempFlags;
}
...
bool32 IsAiBattlerAware(u32 battlerId)
{
    ...
    {
        if ((gAiThinkingStruct->aiFlags[i] & AI_FLAG_OMNISCIENT))
            return TRUE;
    }
...
{
    return gAiThinkingStruct->aiFlags[GetBattlerPosition(battlerId)] & AI_FLAG_PREDICT_MOVE;
}
...
bool32 IsBattlerPredictedToSwitch(u32 battler)
{
    ...
    if (gAiThinkingStruct->aiFlags[GetBattlerPosition(battler)] & AI_FLAG_PREDICT_SWITCH)
    {
...
u32 IncreaseStatDownScore(u32 battlerAtk, u32 battlerDef, enum Stat stat)
{
    ...
    u32 noOfHitsToFaintTarget = NoOfHitsForTargetToFaintBattler(battlerAtk, battlerDef);
