...
#if IS_HNS
static const u16 sMaleHead_Pal[]                 = INCGFX_U16("graphics/frontier_pass/map_heads_hns.png", ".gbapal");
static const u16 sFemaleHead_Pal[]               = INCGFX_U16("graphics/frontier_pass/map_heads_hns.png", ".gbapal");
static const u32 sHeads_Gfx[]                    = INCGFX_U32("graphics/frontier_pass/map_heads_hns.png", ".4bpp.smol");
#else
