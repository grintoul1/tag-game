...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_GRUNT_ROUTE109_5, TRAINER_GRUNT_ROUTE109_6, TRAINER_WALLY_ROUTE_114_M_TREECKO, TRAINER_WALLY_ROUTE_114_M_TORCHIC, MAP_RUSTBORO_CITY),
