...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_HALEY] = REMATCH(TRAINER_HALEY_1, TRAINER_MAXIE_SKY_PILLAR, TRAINER_ARCHIE_SKY_PILLAR, TRAINER_HALEY_5, TRAINER_HALEY_5, MAP_ROUTE104),
    [REMATCH_JAMES] = REMATCH(TRAINER_JAMES_5, TRAINER_JAMES_5, TRAINER_JAMES_5, TRAINER_JAMES_5, TRAINER_JAMES_5, MAP_PETALBURG_WOODS),
