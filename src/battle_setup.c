...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, MAP_ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_5, TRAINER_ANDRES_5, TRAINER_ANDRES_5, TRAINER_ANDRES_5, TRAINER_ANDRES_5, MAP_ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, MAP_ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, MAP_ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, MAP_ROUTE109),
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_VITO_ROUTE111, TRAINER_SHELLY_MOSSDEEP, TRAINER_MATT_MOSSDEEP, TRAINER_ARCHIE_MOSSDEEP, MAP_ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_3, TRAINER_VALERIE_3, TRAINER_VALERIE_3, TRAINER_VALERIE_4, TRAINER_VALERIE_5, MAP_MT_PYRE_6F),
    ...
    [REMATCH_JESSICA] = REMATCH(TRAINER_JESSICA_1, TRAINER_BLUE_MAUVILLE, TRAINER_JESSICA_3, TRAINER_JESSICA_4, TRAINER_JESSICA_5, MAP_ROUTE121),
    ...
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_2, TRAINER_BERNIE_2, TRAINER_BERNIE_3, TRAINER_BERNIE_4, TRAINER_BERNIE_5, MAP_ROUTE114),
    ...
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY_1, TRAINER_TATE, TRAINER_LIZA, TRAINER_SABRINA_MOSSDEEP, TRAINER_JERRY_5, MAP_ROUTE116),
    ...
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_GRUNT_MAGMA_SKY_PILLAR_4, TRAINER_GRUNT_AQUA_SKY_PILLAR_1, TRAINER_GRUNT_AQUA_SKY_PILLAR_2, TRAINER_LYDIA_5, MAP_ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_ISAAC_1, TRAINER_GRUNT_MAGMA_SKY_PILLAR_1, TRAINER_GRUNT_MAGMA_SKY_PILLAR_2, TRAINER_GRUNT_MAGMA_SKY_PILLAR_3, TRAINER_ISAAC_5, MAP_ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_CATHERINE_1, TRAINER_MATT_SKY_PILLAR, TRAINER_COURTNEY_SKY_PILLAR, TRAINER_SHELLY_SKY_PILLAR, TRAINER_CATHERINE_5, MAP_ROUTE119),
    [REMATCH_JACKSON] = REMATCH(TRAINER_JACKSON_1, TRAINER_GRUNT_AQUA_SKY_PILLAR_3, TRAINER_GRUNT_AQUA_SKY_PILLAR_4, TRAINER_TABITHA_SKY_PILLAR, TRAINER_JACKSON_5, MAP_ROUTE119),
    [REMATCH_HALEY] = REMATCH(TRAINER_HALEY_1, TRAINER_MAXIE_SKY_PILLAR, TRAINER_ARCHIE_SKY_PILLAR, TRAINER_MAGMA_GRUNT_SPACE_CENTER_5, TRAINER_MAGMA_GRUNT_SPACE_CENTER_5, MAP_ROUTE104),
    [REMATCH_JAMES] = REMATCH(TRAINER_MAGMA_GRUNT_SPACE_CENTER_6, TRAINER_MAGMA_GRUNT_SPACE_CENTER_6, TRAINER_MAGMA_GRUNT_SPACE_CENTER_6, TRAINER_MAGMA_GRUNT_SPACE_CENTER_6, TRAINER_MAGMA_GRUNT_SPACE_CENTER_6, MAP_PETALBURG_WOODS),
    [REMATCH_TRENT] = REMATCH(TRAINER_TRENT_5, TRAINER_TRENT_5, TRAINER_TRENT_5, TRAINER_TRENT_5, TRAINER_TRENT_5, MAP_ROUTE112),
    ...
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_ROUTE_114_M_MUDKIP, TRAINER_WALLY_ROUTE_114_M_MUDKIP, TRAINER_WALLY_VR_4, TRAINER_WALLY_VR_5, TRAINER_WALLY_VR_5, MAP_VICTORY_ROAD_1F),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROCKETS_AQUA_HIDEOUT, TRAINER_ROCKETS_SEAFLOOR_CAVERN, TRAINER_WALLY_ROUTE_114_M_TREECKO, TRAINER_WALLY_ROUTE_114_M_TORCHIC, MAP_RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_WALLY_ROUTE_114_F_MUDKIP, TRAINER_WALLY_ROUTE_114_F_TREECKO, TRAINER_WALLY_ROUTE_114_F_TORCHIC, TRAINER_BRAWLY_5, MAP_DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_BLAINE_PETALBURG, TRAINER_GIOVANNI_SLATEPORT, TRAINER_MISTY_LAVARIDGE, TRAINER_SURGE_LAVARIDGE, MAP_MAUVILLE_CITY),
    ...
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_ERIKA_RUSTBORO, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, MAP_MOSSDEEP_CITY),
...
{
    CreateMaleMon(&gParties[B_TRAINER_OPPONENT_A][0], SPECIES_RALTS, 5, FALSE);
    LockPlayerFieldControls();
...
{
    CreateMaleMon(&gParties[B_TRAINER_OPPONENT_A][0], SPECIES_WEEDLE, 5, FALSE);
    LockPlayerFieldControls();
    gMain.savedCallback = CB2_ReturnToFieldContinueScriptPlayMapMusic;
    gBattleTypeFlags = BATTLE_TYPE_CATCH_TUTORIAL;
    CreateBattleStartTask(B_TRANSITION_SLICE, 0);
...
void BattleSetup_StartScriptedRayquazaBattle(void)
{
    LockPlayerFieldControls();
    gMain.savedCallback = CB2_EndScriptedWildBattle;
    gBattleTypeFlags = (BATTLE_TYPE_DOUBLE | BATTLE_TYPE_MULTI | BATTLE_TYPE_INGAME_PARTNER | BATTLE_TYPE_RAYQUAZA);
    CreateBattleStartTask(B_TRANSITION_RAYQUAZA_TAG, MUS_VS_RAYQUAZA);
    IncrementGameStat(GAME_STAT_TOTAL_BATTLES);
    IncrementGameStat(GAME_STAT_WILD_BATTLES);
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
...
void StartMarowakBattle(void)
{
    ...
    if (CheckBagHasItem(ITEM_SILPH_SCOPE, 1))
    {
        ...
        CreateMonWithIVsPersonality(&gParties[B_TRAINER_OPPONENT_A][0], SPECIES_MAROWAK, 30, 31, personality, FALSE);
    }
...
static void CB2_GiveStarter(void)
{
    ...
    *GetVarPointer(VAR_STARTER_MON) = gSpecialVar_Result;
    ...
    for(i = 0; i < 1; i++)
    {
        SetMonData(&gParties[B_TRAINER_PLAYER][i], MON_DATA_ABILITY_NUM, &j);
    }
    ResetTasks();
    PlayBattleBGM();
...
void CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer)
{
    ...
    Free(trainerGen);
        if (TRAINER_BATTLE_PARAM.opponentA == TRAINER_EMMIE_1)
        {
            ...
            for (s32 i = 0; i < 6; i++)
            {
                CopyMon(&gParties[B_TRAINER_OPPONENT_A][i], &gParties[B_TRAINER_PLAYER][i], sizeof(*&gParties[B_TRAINER_PLAYER][i]));
                j = gExperienceTables[gSpeciesInfo[GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_SPECIES)].growthRate][VarGet(VAR_LEVEL_CAP)];
                if((j > GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_EXP, NULL)))
                {
                    SetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_EXP, &j);
                    CalculateMonStats(&gParties[B_TRAINER_OPPONENT_A][i]);
                }
                j = GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_MAX_HP, NULL);
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_HP, &j);
                j = gMovesInfo[GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_MOVE1, NULL)].pp;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_PP1, &j);
                j = gMovesInfo[GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_MOVE2, NULL)].pp;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_PP2, &j);
                j = gMovesInfo[GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_MOVE3, NULL)].pp;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_PP3, &j);
                j = gMovesInfo[GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_MOVE4, NULL)].pp;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_PP4, &j);
                j = STATUS1_NONE;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_STATUS, &j);
            }
            j = NATURE_RELAXED;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_HIDDEN_NATURE, &j);
            j = NATURE_SERIOUS;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][1], MON_DATA_HIDDEN_NATURE, &j);
            j = NATURE_BRAVE;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][2], MON_DATA_HIDDEN_NATURE, &j);
            j = NATURE_SASSY;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][3], MON_DATA_HIDDEN_NATURE, &j);
            j = NATURE_BASHFUL;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][4], MON_DATA_HIDDEN_NATURE, &j);
            j = NATURE_QUIET;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][5], MON_DATA_HIDDEN_NATURE, &j);

            j = ITEM_FOCUS_SASH;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_HELD_ITEM, &j);
            j = ITEM_IRON_BALL;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][1], MON_DATA_HELD_ITEM, &j);
            j = ITEM_EJECT_BUTTON;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][2], MON_DATA_HELD_ITEM, &j);
            j = ITEM_LAGGING_TAIL;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][3], MON_DATA_HELD_ITEM, &j);
            j = ITEM_SITRUS_BERRY;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][4], MON_DATA_HELD_ITEM, &j);
            j = ITEM_STICKY_BARB;
            SetMonData(&gParties[B_TRAINER_OPPONENT_A][5], MON_DATA_HELD_ITEM, &j);
        }
        if (TRAINER_BATTLE_PARAM.opponentA == TRAINER_EMMIE_2)
        {
            ...
            for (s32 i = 3; i < 6; i++)
            {
                CopyMon(&gParties[B_TRAINER_OPPONENT_A][i], &gParties[B_TRAINER_PLAYER][i-3], sizeof(*&gParties[B_TRAINER_PLAYER][i-3]));
                gBattleTypeFlags |= BATTLE_TYPE_DOUBLE | BATTLE_TYPE_MULTI | BATTLE_TYPE_INGAME_PARTNER;
        ...
        DebugPrintf("Check5");
            ...
            j = SPECIES_TORNADUS;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_SPECIES, &j);
            j = SPECIES_THUNDURUS;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][1], MON_DATA_SPECIES, &j);
            j = SPECIES_LANDORUS;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][2], MON_DATA_SPECIES, &j);
            j = 0;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_ABILITY_NUM, &j);
            j = 0;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][1], MON_DATA_ABILITY_NUM, &j);
            j = 0;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][2], MON_DATA_ABILITY_NUM, &j);
            j = NATURE_SERIOUS;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_HIDDEN_NATURE, &j);
            j = NATURE_TIMID;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][1], MON_DATA_HIDDEN_NATURE, &j);
            j = NATURE_BRAVE;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][2], MON_DATA_HIDDEN_NATURE, &j);
            j = MOVE_TAILWIND;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_MOVE1, &j);
            j = MOVE_TAUNT;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][1], MON_DATA_MOVE1, &j);
            j = MOVE_U_TURN;
                SetMonData(&gParties[B_TRAINER_OPPONENT_A][2], MON_DATA_MOVE1, &j);
