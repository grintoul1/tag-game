...
static void DisplayPartyPokemonDataForChooseHalf(u8 slot)
{
    ...
    if (gSpecialVar_0x800A == B_TRAINER_2)
...
static bool8 PartyBoxPal_PartnerOrDisqualifiedInArena(u8 slot)
{
    if (gPartyMenu.layout == PARTY_LAYOUT_MULTI_FULL_PARTNER
     ...
     || gSpecialVar_0x800A == B_TRAINER_2)
    {
        return TRUE;
    }
...
static void UpdatePartySelectionOverworldLayout(s8 *slotPtr, s8 movementDir)
{
    ...
    case MENU_DIR_UP:
        ...
        {
            *slotPtr = (gPartiesCount[B_TRAINER_0] - 1 == 3) ? 2 : gPartiesCount[B_TRAINER_0] - 1;
            break;
        }
        else if (*slotPtr == 1)
        {
        ...
        else if (*slotPtr == PARTY_SIZE + 1)
        {
            ...
            if (gPartiesCount[B_TRAINER_0] - 1 == 3)
            {
                *slotPtr = 2;
                break;
            }
    ...
    case MENU_DIR_DOWN:
        ...
        {
            *slotPtr = (gPartiesCount[B_TRAINER_0] - 1 == 3) ? PARTY_SIZE + 1 : 4;
            break;
        }
        else if (*slotPtr == 3)
        {
    ...
    case MENU_DIR_RIGHT:
        if (*slotPtr == 0)
        {
            ...
            {
                if (GetMonData(&gParties[B_TRAINER_0][2], MON_DATA_SPECIES) != SPECIES_NONE)
                    *slotPtr = 2;
            }
            else if (GetMonData(&gParties[B_TRAINER_0][1], MON_DATA_SPECIES) != SPECIES_NONE)
            {
                *slotPtr = 1;
            }
        }
...
static void CursorCb_Status(u8 taskId)
{
    ...
    PartyMenuRemoveWindow(&sPartyMenuInternal->windowId[0]);
    PartyMenuRemoveWindow(&sPartyMenuInternal->windowId[1]);
    SetPartyMonSelectionActions(gParties[B_TRAINER_0], gPartyMenu.slotId, ACTIONS_STATUS);
...
{
    s16 *data = gTasks[taskId].data;
    s16 maxHP=gParties[B_TRAINER_0][gPartyMenu.slotId].maxHP;
    struct Pokemon *mon=&gParties[B_TRAINER_0][gPartyMenu.slotId];
...
static void CursorCb_Damage(u8 taskId)
{
    ...
    PartyMenuRemoveWindow(&sPartyMenuInternal->windowId[0]);
    PartyMenuRemoveWindow(&sPartyMenuInternal->windowId[1]);
    SetPartyMonSelectionActions(gParties[B_TRAINER_0], gPartyMenu.slotId, ACTIONS_DAMAGE);
...
static void CursorCb_Poison(u8 taskId)
{
    ...
    PartyMenuRemoveWindow(&sPartyMenuInternal->windowId[0]);
    PartyMenuRemoveWindow(&sPartyMenuInternal->windowId[1]);
    SetPartyMonSelectionActions(gParties[B_TRAINER_0], gPartyMenu.slotId, ACTIONS_POISON);
...
static void Task_ValidateChosenStoryParty(u8 taskId)
{
    ...
    {
        PlaySE(SE_SELECT);
        if (gSpecialVar_0x800A == B_TRAINER_0)
        {
