...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_HOSPITALITY, ABILITY_SHELL_ARMOR, ABILITY_SYMBIOSIS },
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_IRON_FIST, ABILITY_BLAZE },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_CLEAR_BODY, ABILITY_COMPETITIVE },
    #else
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_STURDY, ABILITY_SOUNDPROOF, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GRAY,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_GABITE}),
    },
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_NONE, ABILITY_HAIL_WARNING },
        .bodyColor = BODY_COLOR_WHITE,
