...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_SYMBIOSIS, ABILITY_SOLAR_POWER },
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_PIXILATE, ABILITY_SYMBIOSIS, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MEGANIUM_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_PIXILATE, ABILITY_MEGA_SOL, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Meganium"),
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .abilities = { ABILITY_UNNERVE, ABILITY_FLAME_BODY, ABILITY_FLASH_FIRE },
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                {EVO_LEVEL, 36, SPECIES_TYPHLOSION_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_ABANDONED_SHIP})}),
    },
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_LANTURN}),
    },
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_GALVANIZE, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_GALVANIZE, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ampharos"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 5, SPECIES_MARILL}),
    },
    ...
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_INFILTRATOR, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_YANMEGA}),
    #endif
    },
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .abilities = { ABILITY_DAMP, ABILITY_UNAWARE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_QUAGSIRE}),
    },
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .formSpeciesIdTable = sWooperFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_CLODSIRE}),
    },
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 39, SPECIES_HONCHKROW}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .abilities = { ABILITY_PIXILATE, ABILITY_PIXILATE, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_INTIMIDATE, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .formSpeciesIdTable = sQwilfishFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 41, SPECIES_OVERQWIL}),
    },
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_UNBURDEN, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_PILOSWINE}),
    },
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNNERVE, ABILITY_SOLAR_POWER, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .abilities = { ABILITY_TERAVOLT, ABILITY_NONE, ABILITY_INNER_FOCUS },
    #else
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_NONE, ABILITY_INNER_FOCUS },
    #else
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_UNBURDEN, ABILITY_NONE, ABILITY_INNER_FOCUS },
    #else
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 53, SPECIES_TYRANITAR}),
    },
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_SAND_STREAM, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Tyranitar"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_NONE, ABILITY_SYNCHRONIZE },
        .bodyColor = BODY_COLOR_GREEN,
