...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_BULLETPROOF, ABILITY_OVERGROW },
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TELEPATHY, ABILITY_MAGIC_GUARD, ABILITY_MAGICIAN },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_PROTEAN, ABILITY_PROTEAN },
    ...
    [SPECIES_GRENINJA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_PROTEAN, ABILITY_BATTLE_BOND },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_GALE_WINGS, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_TALONFLAME}),
    },
...
#define SCATTERBUG_SPECIES_INFO(evolution)                                                  \
    {                                                                                       \
        ...
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_COMPOUND_EYES, ABILITY_SHED_SKIN },    \
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                                   \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),                                         \
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_COMPOUND_EYES, ABILITY_SHIELD_DUST },  \
        .bodyColor = color,                                                                 \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 31, SPECIES_PYROAR}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_SOLAR_POWER, ABILITY_DRY_SKIN },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_SLIGGOO_HISUI}),
    },
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_AVALUGG},
    ...
    [SPECIES_AVALUGG_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_STRONG_JAW, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Avalugg"),
        .cryId = CRY_AVALUGG,
        .natDexNum = NATIONAL_DEX_AVALUGG,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .abilities = { ABILITY_AERILATE, ABILITY_TELEPATHY, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DROUGHT, ABILITY_DRIZZLE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BROWN,
