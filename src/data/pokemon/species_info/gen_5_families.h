...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SNIVY] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_UNBURDEN, ABILITY_CONTRARY },
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_TOUGH_CLAWS, ABILITY_THICK_FAT },
    ...
    [SPECIES_EMBOAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_TOUGH_CLAWS, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
