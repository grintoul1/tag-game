const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_PKMN_TRAINER_1] = TRAINER_PIC_BRENDAN,
    [FACILITY_CLASS_PKMN_TRAINER_2] = TRAINER_PIC_GREEN,
};
...
const u16 gTrainerPicToTrainerBackPic[] =
{
    ...
    [TRAINER_BACK_PIC_AQUA_LEADER_ARCHIE] = TRAINER_PIC_AQUA_LEADER_ARCHIE,
    [TRAINER_BACK_PIC_MAGMA_LEADER_MAXIE] = TRAINER_PIC_MAGMA_LEADER_MAXIE,
    [TRAINER_BACK_PIC_AQUA_ADMIN_M] = TRAINER_PIC_AQUA_ADMIN_M,
    [TRAINER_BACK_PIC_AQUA_ADMIN_F] = TRAINER_PIC_AQUA_LEADER_ARCHIE,
    [TRAINER_BACK_PIC_MAGMA_ADMIN] = TRAINER_PIC_MAGMA_ADMIN,
    [TRAINER_BACK_PIC_MAGMA_ADMIN_F] = TRAINER_PIC_MAGMA_ADMIN_F,
    [TRAINER_BACK_PIC_GREEN] = TRAINER_PIC_GREEN,
};

const u16 gLeaderPicToBadgePic[] =
{
    [TRAINER_ROXANNE_1] = TRAINER_PIC_STONE_BADGE,
    [TRAINER_BRAWLY_1] = TRAINER_PIC_KNUCKLE_BADGE,
    [TRAINER_WATTSON_1] = TRAINER_PIC_DYNAMO_BADGE,
    [TRAINER_FLANNERY_1] = TRAINER_PIC_HEAT_BADGE,
    [TRAINER_NORMAN_1] = TRAINER_PIC_BALANCE_BADGE,
    [TRAINER_WINONA_1] = TRAINER_PIC_FEATHER_BADGE,
    [TRAINER_TATE_AND_LIZA_1] = TRAINER_PIC_MIND_BADGE,
    [TRAINER_JUAN_1] = TRAINER_PIC_RAIN_BADGE,
};
...
const u16 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_STEVEN] = TRAINER_CLASS_FORMER_CHAMPION,
    ...
    [FACILITY_CLASS_PKMN_TRAINER_1] = TRAINER_CLASS_PKMN_TRAINER_1,
    [FACILITY_CLASS_PKMN_TRAINER_2] = TRAINER_CLASS_PKMN_TRAINER_2,
};
