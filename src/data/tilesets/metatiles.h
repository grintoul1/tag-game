...
const u16 gMetatiles_team_aqua_magma[] = INCBIN_U16("data/tilesets/primary/team_aqua_magma/metatiles.bin");
const u16 gMetatileAttributes_team_aqua_magma[] = INCBIN_U16("data/tilesets/primary/team_aqua_magma/metatile_attributes.bin");
