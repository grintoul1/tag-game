...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GREEN, gTrainerFrontPic_Green, gTrainerPalette_Green),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_MAGMA_LEADER_MAXIE, 4, gTrainerBackPic_MagmaLeaderMaxie, gTrainerBackPicPalette_MagmaLeaderMaxie, sBackAnims_Hoenn),
    ...
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_MAGMA_ADMIN, 5, gTrainerBackPic_MagmaAdminM, gTrainerBackPicPalette_MagmaAdminM, sBackAnims_Kanto),
