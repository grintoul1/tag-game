...
const u16 gTrainerPalette_LeaderTate[] = INCGFX_U16("graphics/trainers/front_pics/leader_tate.pal", ".gbapal");

const u32 gTrainerFrontPic_LeaderLiza[] = INCGFX_U32("graphics/trainers/front_pics/leader_liza.png", ".4bpp.smol");
const u16 gTrainerPalette_LeaderLiza[] = INCGFX_U16("graphics/trainers/front_pics/leader_liza.pal", ".gbapal");
...
const u32 gTrainerFrontPic_Green[] = INCGFX_U32("graphics/trainers/front_pics/green.png", ".4bpp.smol");
const u16 gTrainerPalette_Green[] = INCGFX_U16("graphics/trainers/palettes/green.pal", ".gbapal");

const u32 gTrainerFrontPic_Vito[] = INCGFX_U32("graphics/trainers/front_pics/vito.png", ".4bpp.smol");
...
const u8 gTrainerBackPic_Green[] = INCGFX_U8("graphics/trainers/back_pics/green.png", ".4bpp");
...
const u8 gTrainerBackPic_MagmaLeaderMaxie[] = INCGFX_U8("graphics/trainers/back_pics/magma_leader_maxie.png", ".4bpp");
const u8 gTrainerBackPic_AquaLeaderArchie[] = INCGFX_U8("graphics/trainers/back_pics/aqua_leader_archie.png", ".4bpp");
const u8 gTrainerBackPic_MagmaAdminM[] = INCGFX_U8("graphics/trainers/back_pics/magma_admin_m.png", ".4bpp");
...
const u8 gTrainerBackPic_Misty[] = INCGFX_U8("graphics/trainers/back_pics/misty.png", ".4bpp");
const u8 gTrainerBackPic_Surge[] = INCGFX_U8("graphics/trainers/back_pics/surge.png", ".4bpp");
const u8 gTrainerBackPic_Erika[] = INCGFX_U8("graphics/trainers/back_pics/erika.png", ".4bpp");
...
const u16 gTrainerBackPicPalette_Misty[] = INCGFX_U16("graphics/trainers/back_pics/misty.png", ".gbapal");
const u16 gTrainerBackPicPalette_Surge[] = INCGFX_U16("graphics/trainers/back_pics/surge.png", ".gbapal");
const u16 gTrainerBackPicPalette_Erika[] = INCGFX_U16("graphics/trainers/back_pics/erika.png", ".gbapal");
...
const struct TrainerPicInfo gTrainerPicInfo[TRAINER_PIC_COUNT] =
{
    ...
    [TRAINER_PIC_AQUA_LEADER_ARCHIE] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(4, gTrainerBackPic_AquaLeaderArchie, gTrainerBackPicPalette_AquaLeaderArchie, sBackAnims_Hoenn),
    },
    ...
    [TRAINER_PIC_MAGMA_LEADER_MAXIE] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(4, gTrainerBackPic_MagmaLeaderMaxie, gTrainerBackPicPalette_MagmaLeaderMaxie, sBackAnims_Hoenn),
    },
    [TRAINER_PIC_LASS] =
    {
    ...
    [TRAINER_PIC_RIVAL_EARLY_FRLG] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(5, gTrainerBackPic_Blue, gTrainerBackPicPalette_Blue, sBackAnims_Kanto),
    },
    ...
    [TRAINER_PIC_LEADER_MISTY_FRLG] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(4, gTrainerBackPic_Misty, gTrainerBackPicPalette_Misty, sBackAnims_Hoenn),
    },
    [TRAINER_PIC_LEADER_LT_SURGE_FRLG] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(4, gTrainerBackPic_Surge, gTrainerBackPicPalette_Surge, sBackAnims_Hoenn),
    },
    [TRAINER_PIC_LEADER_ERIKA_FRLG] =
    {
        .frontPic = TRAINER_FRONT_PIC(gTrainerFrontPic_LeaderErikaFrlg, gTrainerPalette_LeaderErikaFrlg),
        .backPic = TRAINER_BACK_PIC(4, gTrainerBackPic_Erika, gTrainerBackPicPalette_Erika, sBackAnims_Hoenn),
    },
    ...
    [TRAINER_PIC_LEADER_SABRINA_FRLG] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(4, gTrainerBackPic_Sabrina, gTrainerBackPicPalette_Sabrina, sBackAnims_Hoenn),
    },
    ...
    [TRAINER_PIC_GREEN] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(5, gTrainerBackPic_Green, gTrainerBackPicPalette_Green, sBackAnims_Kanto),
    },
