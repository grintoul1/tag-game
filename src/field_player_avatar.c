...
static const u8 sEmmieAvatarGfxIds[][2] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_SISTER_NORMAL,      OBJ_EVENT_GFX_SISTER_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_SISTER_MACH_BIKE,   OBJ_EVENT_GFX_SISTER_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_SISTER_ACRO_BIKE,   OBJ_EVENT_GFX_SISTER_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_SISTER_SURFING,     OBJ_EVENT_GFX_SISTER_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_SISTER_UNDERWATER,  OBJ_EVENT_GFX_SISTER_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_SISTER_FIELD_MOVE,  OBJ_EVENT_GFX_SISTER_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_SISTER_FISHING,     OBJ_EVENT_GFX_SISTER_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_SISTER_FIELD_MOVE,    OBJ_EVENT_GFX_SISTER_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_SISTER_FIELD_MOVE,  OBJ_EVENT_GFX_SISTER_FIELD_MOVE},
};
