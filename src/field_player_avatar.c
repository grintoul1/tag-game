...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_GREEN_NORMAL,      OBJ_EVENT_GFX_GREEN_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_GREEN_MACH_BIKE,   OBJ_EVENT_GFX_GREEN_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_GREEN_ACRO_BIKE,   OBJ_EVENT_GFX_GREEN_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_GREEN_SURFING,     OBJ_EVENT_GFX_GREEN_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_GREEN_UNDERWATER,  OBJ_EVENT_GFX_GREEN_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_GREEN_FIELD_MOVE,  OBJ_EVENT_GFX_GREEN_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_GREEN_FISHING,     OBJ_EVENT_GFX_GREEN_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_GREEN_FIELD_MOVE,    OBJ_EVENT_GFX_GREEN_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_GREEN_FIELD_MOVE,  OBJ_EVENT_GFX_GREEN_FIELD_MOVE},
};
