...
static const u8 sText_StopKyogreGroudon[] = _("This is your chance to stop Kyogre and Groudon!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNMENTALHERBPREVENTEDFLINCHING]     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Mental Herb prevented flinching!"),
    ...
    [STRINGID_INVERSIONPOLICYSTARTS]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Inversion Policy changed type match-ups!"),
    [STRINGID_INVERSIONPOLICYENDS]                  = COMPOUND_STRING("The effects of the Inversion Policy wore off!"),
    [STRINGID_DISTRACTIONPOLICYSTARTS]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Distraction Policy made it the centre of attention!"),
    [STRINGID_DISTRACTIONPOLICYENDS]                = COMPOUND_STRING("The effects of the Distraction Policy wore off!"),
    [STRINGID_SPOTLIGHTPOLICYSTARTS]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Spotlight Policy shone a light on its ally!"),
    [STRINGID_SPOTLIGHTPOLICYENDS]                  = COMPOUND_STRING("The effects of the Spotlight Policy wore off!"),
    ...
    [STRINGID_HAILWARNINGHAIL]                      = COMPOUND_STRING("It started to hail!"),
...
const u16 gMentalHerbCureStringIds[] =
{
    ...
    [B_MSG_MENTALHERBCURE_FLINCH]      = STRINGID_PKMNMENTALHERBPREVENTEDFLINCHING,
...
void BufferStringBattle(enum StringID stringID, enum BattlerId battler)
{
    ...
    case STRINGID_INTROMSG: // first battle msg
        ...
        else
        {
            if (IsGhostBattleWithoutScope())
                ...
                stringPtr = sText_StopKyogreGroudon;
    ...
    case STRINGID_INTROSENDOUT: // poke first send-out
        if (IsOnPlayerSide(battler))
        {
            ...
            else if (IsDoubleBattle() && IsValidForBattle(GetBattlerMon(GetPartnerBattler(battler))))
            {
