...
const u8 gText_xVar2[] = _("{STR_VAR_1}");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} Pokémon\nmay be selected.{PAUSE_UNTIL_PRESS}");
const u8 gText_CannotSelectPkmn[] = _("You cannot select this Pokémon.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnWasElevatedToLvVar3[] = _("{STR_VAR_1} was elevated to Lv. {STR_VAR_3}!");
...
const u8 gText_NoPokemonForBattle[] = _("No Pokémon selected!");
...
const u8 gText_WhichStatus[] = _("Which status?");
const u8 gText_SetHP[] = _("Set HP.");
...
const u8 gText_ChoiceBand[] = _("Choice Band");
const u8 gText_ChoiceSpecs[] = _("Choice Specs");
const u8 gText_ChoiceScarf[] = _("Choice Scarf");
const u8 gText_Punching[] = _("Punching");
const u8 gText_Kicking[] = _("Kicking");
const u8 gText_Balance[] = _("Balance");
const u8 gText_ExchangeShellyParty[] = _("Shelly's party");
const u8 gText_ExchangeTabithaParty[] = _("Tabitha's party");
const u8 gText_ExchangeYourParty[] = _("Your party");
...
const u8 gText_MenuUtility[] = _("Utility");
...
const u8 gText_RentalPkmn2[] = _("Pool Pokémon");
...
const u8 gText_Rent[] = _("Select");
const u8 gText_Summary[] = _("Summary");
const u8 gText_Others2[] = _("Cancel");
const u8 gText_Deselect[] = _("Deselect");
const u8 gText_TheseThreePkmnOkay[] = _("Exchange these Pokémon?");
const u8 gText_Yes2[] = _("Yes");
const u8 gText_No2[] = _("No");
const u8 gText_CantSelectSamePkmn[] = _("Can't select this option.");
